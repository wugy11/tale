...
CREATE TABLE t_users (uid INTEGER PRIMARY KEY UNIQUE NOT NULL, username VARCHAR (64) UNIQUE NOT NULL, password VARCHAR (64) NOT NULL, email VARCHAR (100), home_url VARCHAR (255), 
screen_name VARCHAR (100), created INTEGER (10) NOT NULL, activated INTEGER (10), logged INTEGER (10), group_name VARCHAR (16));

DROP TABLE IF EXISTS t_books;
CREATE TABLE t_books (id INTEGER PRIMARY KEY AUTOINCREMENT UNIQUE NOT NULL, name VARCHAR (32) NOT NULL, begin_time INTEGER(10) NOT NULL, end_time INTEGER(10), status CHAR(4) NOT NULL);

DROP TABLE IF EXISTS t_finance;
create table t_finance (id INTEGER PRIMARY KEY AUTOINCREMENT UNIQUE NOT NULL,  money VARCHAR(32) NOT NULL, type CHAR(4) NOT NULL, create_time INTEGER(10) NOT NULL,
expense_time INTEGER(10) NOT NULL, uid INTEGER, remark VARCHAR(128), category CHAR(4) NOT NULL DEFAULT '支出')
