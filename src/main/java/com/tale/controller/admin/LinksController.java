...
public class LinksController extends BaseController {
	...
	@JSON
	public RestResponse saveLink(@QueryParam String title, @QueryParam String url, @QueryParam String logo,
			@QueryParam Integer mid, @QueryParam(defaultValue = "0") int sort) {
		try {
